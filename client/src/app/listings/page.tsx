...
export default function ListingsPage() {
  ...
  const handleBook = async () => {
    ...
    // Check authentication before attempting to book
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950/20 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Search & Filter Bar */}
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-4 sm:p-5 rounded-2xl shadow-md space-y-4">
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all duration-200 cursor-pointer ${
                    selectedCategory === cat
                      ...
                      : "bg-neutral-100 dark:bg-neutral-850 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-250 dark:hover:bg-neutral-800"
                  }`}
                >
                  {cat}
                </button>
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl py-16 text-center max-w-xl mx-auto space-y-4">
          ...
          <div className="space-y-8">
            {/* Top Toolbar / Status */}
            <div className="flex items-center justify-between text-xs text-neutral-500 dark:text-neutral-400 pb-1">
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {listings.map((listing) => (
                <div
                  ...
                  className="group cursor-pointer bg-white dark:bg-neutral-900 border border-neutral-200/60 dark:border-neutral-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col h-full"
                >
                  ...
                  >
                    <div className="absolute inset-0 bg-neutral-950/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <span className="bg-white/95 dark:bg-neutral-950/95 text-neutral-900 dark:text-white text-[11px] font-bold px-3 py-1.5 rounded-lg shadow-sm">
        ...
        {selectedListing && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-950/60 backdrop-blur-sm">
            <div className="w-full max-w-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl overflow-hidden shadow-2xl relative animate-in fade-in zoom-in duration-200 max-h-[90vh] flex flex-col">
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 bg-white/95 dark:bg-neutral-950/95 text-neutral-900 dark:text-white text-[10px] font-extrabold px-3 py-1.5 rounded-full uppercase tracking-wider shadow-sm">
              ...
              <div className="p-6 overflow-y-auto space-y-6 flex-grow">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-semibold text-neutral-500 dark:text-neutral-400 flex items-center gap-1">
                ...
                {selectedListing.vendor && (
                  <div className="bg-neutral-50 dark:bg-neutral-950 p-4 rounded-xl border border-neutral-200/50 dark:border-neutral-850 space-y-3">
                    <div className="flex items-center gap-2">
                      <User className="h-4.5 w-4.5 text-indigo-600 dark:text-violet-400" />
                      <h4 className="text-xs font-bold text-neutral-700 dark:text-neutral-300 uppercase tracking-wider">
                        Host Information
                      </h4>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                      <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-3 w-full sm:w-auto shrink-0 justify-end">
                    <div className="flex flex-col text-left shrink-0">
                      ...
                      <select
                        ...
                        className="text-xs font-bold border border-neutral-300 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-neutral-700 dark:text-white rounded px-2 py-1 focus:outline-none"
                      >
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <p className="text-sm font-extrabold text-indigo-600 dark:text-violet-400">
              ...
              <div className="p-4 bg-neutral-50 dark:bg-neutral-950/60 border-t border-neutral-100 dark:border-neutral-850 shrink-0 flex items-center justify-between gap-4">
                ...
                {bookingSuccess ? (
                  ...
                  <button
                    onClick={handleBook}
                    className="bg-indigo-600 hover:bg-indigo-500 dark:bg-violet-600 dark:hover:bg-violet-500 text-white text-xs font-bold px-6 py-2.5 rounded-lg transition-colors cursor-pointer shadow-md shadow-indigo-500/15"
                  >
                    Reserve Now
                  </button>
                )}
