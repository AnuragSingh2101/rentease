      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-6 rounded-2xl shadow-sm">
          <div className="flex items-center gap-4">
            <Link
              ...
              className="p-2.5 rounded-xl border border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors text-neutral-500 hover:text-neutral-700 dark:hover:text-white"
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl sm:text-2xl font-extrabold text-neutral-900 dark:text-white">Analytics & Metrics Insights</h1>
              ...
              <p className="text-xs sm:text-sm text-neutral-500 dark:text-neutral-400">Deep-dive performance graphs, category utilization, and user retention metrics.</p>
            </div>
          </div>
          <button
            onClick={fetchAnalytics}
            disabled={loading}
            className="self-start sm:self-center flex items-center gap-2 px-4 py-2 border border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-xl text-xs font-semibold text-neutral-700 dark:text-neutral-300 disabled:opacity-50 transition-all cursor-pointer"
          >
        ...
        {loading ? (
          ...
          <div className="space-y-8 animate-in fade-in duration-200">
            ...
            {/* Top Cards for key stats */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 flex items-center gap-4 shadow-sm">
                ...
                <div>
                  <p className="text-xl font-extrabold text-neutral-900 dark:text-white">₹{data.cards.revenue.toLocaleString("en-IN")}</p>
                  <p className="text-[10px] sm:text-xs text-neutral-500 dark:text-neutral-400 font-semibold">Total Revenue</p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 flex items-center gap-4 shadow-sm">
                ...
                <div>
                  <p className="text-xl font-extrabold text-neutral-900 dark:text-white">{data.cards.activeRentals}</p>
                  <p className="text-[10px] sm:text-xs text-neutral-500 dark:text-neutral-400 font-semibold">Active Agreements</p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 flex items-center gap-4 shadow-sm">
                ...
                <div>
                  <p className="text-xl font-extrabold text-neutral-900 dark:text-white">{data.customerRetentionRate}%</p>
                  <p className="text-[10px] sm:text-xs text-neutral-500 dark:text-neutral-400 font-semibold">Customer Retention</p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 flex items-center gap-4 shadow-sm">
                ...
                <div>
                  <p className="text-xl font-extrabold text-neutral-900 dark:text-white">{data.avgMaintenanceResolutionHours} hrs</p>
                  <p className="text-[10px] sm:text-xs text-neutral-500 dark:text-neutral-400 font-semibold">Maintenance Speed</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {/* Line Chart: Monthly revenue trends (span 2 cols) */}
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 lg:col-span-2 space-y-4">
                <div className="flex items-center gap-2">
              ...
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 space-y-4 flex flex-col justify-between">
                <div className="flex items-center gap-2">
              ...
              {/* Bar Chart: Product category utilization */}
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 lg:col-span-3 space-y-4">
                <div className="flex items-center gap-2">
                ...
                <div className="p-4 border border-dashed border-neutral-200 dark:border-neutral-800 rounded-xl bg-neutral-50/20 dark:bg-neutral-950/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs">
                  ...
                  <div className="flex flex-wrap gap-4 shrink-0 font-semibold text-neutral-600 dark:text-neutral-400">
                    {data.productUtilization.map(u => (
                      <div key={u.category}>
                        <span>{u.category}: </span>
                        <strong className="text-neutral-900 dark:text-white">{u.Rented}/{u.Total}</strong>
                      </div>
                    ))}
                  </div>
                </div>
